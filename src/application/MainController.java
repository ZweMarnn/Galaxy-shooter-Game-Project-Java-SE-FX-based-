...
public class MainController implements Initializable {
	...
	public void playingLevel() {
		...
		if (level.equalsIgnoreCase("Level1")) {
			...
			mainBoss = createBoss(380.0, 350.0, "/images/flyingBoss.gif");
			root.getChildren().add(mainBoss);
			flyInFromTop(mainBoss);

			Player enemy1 = createEnemy(80, 100, "/images/flyingEnemy.gif");
			Player enemy2 = createEnemy(280, 155, "/images/flyingEnemy.gif");
			Player enemy3 = createEnemy(450, 100, "/images/flyingEnemy.gif");
	...
	private Player createBoss(double x, double y, String imagePath) {
		return new Player(150, -100, 300.0, 250.0, 10, "enemy", imagePath, 5);
...
//		return root.getChildren().stream().map(a -> (Player) a).toList();
	...
	public void fireBullet(Player boss) {
		String bulletImage = "/images/fire.gif";
		int numBullets = 4;
		...
		for (int i = 0; i < numBullets; i++) {
			...
			Player bullet = new Player(finalBulletX, bulletY, 25, 28, 0, "bossbullet", bulletImage, 5);
			root.getChildren().add(bullet);
